...
from chess.common import MOVE_LIST, MOVE_TO_INDEX_DICT, INDEX_TO_MOVE_DICT, from_array_to_input_tensor, ARRAY_TO_IMAGE
...
def board_to_torch_state(board, player, last_action):
